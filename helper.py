...
def most_successful(df, sport):
    ...
    result_df = successful_athletes.merge(df, left_on='Name', right_on='Name', how='left')
    result_df = result_df[['Name', 'Medals', 'Sport', 'region']].drop_duplicates('Name')
    return result_df
...
def most_successful_countrywise(df, country):
    ...
    successful_athletes = temp_df['Name'].value_counts().reset_index().head(10)
    successful_athletes.columns = ['Name', 'Medals']

    result_df = successful_athletes.merge(df, left_on='Name', right_on='Name', how='left')
    result_df = result_df[['Name', 'Medals', 'Sport']].drop_duplicates('Name')

    return result_df

def weight_v_heigth(df, sport):
